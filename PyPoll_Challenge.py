...
with open(file_to_save, "w") as txt_file:
    ...
    for county, votes in county_votes.items():
        ...
        county_results = f'{county}: {percentage_county_votes:.1f}% ({votes})'
        ...
        if votes > largest_votes_turnout_count:
            largest_votes_turnout_count = votes
